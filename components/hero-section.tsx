      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <div className="space-y-4">
            ...
            >
              <span className="text-orange-500">Automatos AI</span><br/>Stop Fighting Your AI Agent
            </motion.h1>
          ...
          >
            ...
            <a href="https://automatos.app/dashboard" target="_blank" rel="noopener noreferrer"><Button size="lg" variant="outline" className="border-primary/20 hover:bg-primary/10">
